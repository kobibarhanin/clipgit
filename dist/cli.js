...
var _a = require("./actions"), include = _a.include, exclude = _a.exclude, commit = _a.commit, sync = _a.sync, migrate = _a.migrate, show = _a.show, init = _a.init, test = _a.test;
cli.version("0.0.1");
cli
    .command("test")
    .description("...")
...
cli
    ...
    .action(function (staging_directory) {
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, cli.parse(process.argv)];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
